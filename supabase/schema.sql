...
CREATE TABLE public.services (
  ...
  name text NOT NULL,
  description text,
  price integer NOT NULL CHECK (price >= 3500),
...
CREATE TABLE public.bookings (
  ...
  payment_method text CHECK (payment_method = ANY (ARRAY['payfast'::text, 'happypay'::text, 'ozow'::text])),
...
CREATE TABLE public.salon_services (
  ...
  description text,
  price integer NOT NULL,
  deposit_amount integer CHECK (deposit_amount IS NULL OR deposit_amount >= 3500),
  is_active boolean NOT NULL DEFAULT true,
  display_order integer NOT NULL DEFAULT 0,
  created_at timestamp with time zone NOT NULL DEFAULT now(),
...
CREATE TABLE public.booking_intents (
  ...
  payment_method text DEFAULT 'payfast'::text CHECK (payment_method = ANY (ARRAY['payfast'::text, 'happypay'::text, 'ozow'::text])),
  gateway_webhook_secret text,
  gateway_order_id text,
