...
// Legacy values (tradesafe/happypay/google_pay) are kept so orders placed
// under a previous gateway still display a proper label instead of the
// raw DB string — see types/index.ts's PaymentMethod type.
const PAYMENT_LABEL: Record<string, string> = {
  payfast: "PayFast",
  ozow: "Ozow (Instant EFT)",
  tradesafe: "TradeSafe (legacy, escrow)",
