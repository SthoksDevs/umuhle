...
export default function AdminLoginClient() {
  ...
  // ── Step 1: verify credentials → Supabase sends OTP email ──────────────────
  ...
  // ── Step 2: verify OTP → set session → redirect ─────────────────────────────
  async function handleOtp(e: React.FormEvent) {
    ...
    try {
      ...
      // Set the Supabase session directly from the tokens returned
  ...
  return (
    <div style={{
      ...
      <div style={card}>
        ...
        {step === "loading" && (
          <div style={{ textAlign: "center", padding: "2rem 0" }}>
            ...
            <p style={{ color: "var(--grey, #666)", fontSize: "0.9rem" }}>Signing you in…</p>
        ...
        {step === "credentials" && (
          <>
            <h1 style={{ fontSize: "1.2rem", fontWeight: 500, color: "var(--onyx, #1a1a1a)", marginBottom: "0.35rem" }}>
              Admin sign in
            </h1>
        ...
        {step === "otp" && (
          <>
            ...
            <p style={{ fontSize: "0.85rem", color: "var(--grey, #888)", marginBottom: "1.75rem" }}>
              ...
              <strong style={{ color: "var(--onyx, #1a1a1a)" }}>{email}</strong>.
            ...
            <form onSubmit={handleOtp} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              ...
              <button
                type="submit"
                style={{ ...btnStyle, opacity: (busy || otp.join("").length !== 6) ? 0.5 : 1 }}
            ...
            <div style={{ marginTop: "1.25rem", textAlign: "center" }}>
              {countdown > 0 ? (
                ...
                <button
                  ...
                  disabled={busy}
                  style={{ background: "none", border: "none", color: "var(--plum, #9B7FB8)", fontSize: "0.85rem", fontWeight: 500, cursor: "pointer", padding: 0 }}
                >
                  Resend code
                </button>
              )}
              <button
                ...
                style={{ display: "block", margin: "0.5rem auto 0", background: "none", border: "none", color: "var(--grey, #888)", fontSize: "0.82rem", cursor: "pointer", padding: 0 }}
              >
                ← Back
              </button>
            </div>
      ...
      <p style={{ marginTop: "1.5rem", fontSize: "0.75rem", color: "rgba(155,127,184,0.55)", textAlign: "center" }}>
